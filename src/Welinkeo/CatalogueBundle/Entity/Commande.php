 ...
 * @ORM\Entity(repositoryClass="Welinkeo\CatalogueBundle\Repository\CommandeRepository")
 */
class Commande
{
    /**
     ...
     * Set commandestatut
     *
     * @param \Welinkeo\CatalogueBundle\Entity\Commandestatut $commandestatut
     *
     * @return Commande
     */
    public function setCommandestatut(\Welinkeo\CatalogueBundle\Entity\Commandestatut $commandestatut = null)
    {
     ...
     * Get commandestatut
     *
     * @return \Welinkeo\CatalogueBundle\Entity\Commandestatut
     */
     ...
     * Set modepaiement
     *
     * @param \Welinkeo\CatalogueBundle\Entity\Modepaiement $modepaiement
     *
     * @return Commande
     */
    public function setModepaiement(\Welinkeo\CatalogueBundle\Entity\Modepaiement $modepaiement = null)
    {
     ...
     * Get modepaiement
     *
     * @return \Welinkeo\CatalogueBundle\Entity\Modepaiement
     */
     ...
     * Set modelivraison
     *
     * @param \Welinkeo\CatalogueBundle\Entity\Modelivraison $modelivraison
     *
     * @return Commande
     */
    public function setModelivraison(\Welinkeo\CatalogueBundle\Entity\Modelivraison $modelivraison = null)
    {
     ...
     * Get modelivraison
     *
     * @return \Welinkeo\CatalogueBundle\Entity\Modelivraison
     */
     ...
     * Set ordonnance
     *
     * @param \Welinkeo\CatalogueBundle\Entity\Ordonnance $ordonnance
     *
     * @return Commande
     */
    public function setOrdonnance(\Welinkeo\CatalogueBundle\Entity\Ordonnance $ordonnance = null)
    {
     ...
     * Get ordonnance
     *
     * @return \Welinkeo\CatalogueBundle\Entity\Ordonnance
     */
     ...
     *
     * @param \Welinkeo\CatalogueBundle\Entity\Beneficiaire $beneficiairePersonne
     *
     * @return Commande
     */
    public function setBeneficiairePersonne(\Welinkeo\CatalogueBundle\Entity\Beneficiaire $beneficiairePersonne = null)
    {
     ...
     *
     * @return \Welinkeo\CatalogueBundle\Entity\Beneficiaire
     */
     ...
     *
     * @param \Welinkeo\CatalogueBundle\Entity\Utilisateur $utilisateurPersonne
     *
     * @return Commande
     */
    public function setUtilisateurPersonne(\Welinkeo\CatalogueBundle\Entity\Utilisateur $utilisateurPersonne = null)
    {
     ...
     *
     * @return \Welinkeo\CatalogueBundle\Entity\Utilisateur
     */
     ...
     * Set pointlivraison
     *
     * @param \Welinkeo\CatalogueBundle\Entity\Pointlivraison $pointlivraison
     *
     * @return Commande
     */
    public function setPointlivraison(\Welinkeo\CatalogueBundle\Entity\Pointlivraison $pointlivraison = null)
    {
     ...
     * Get pointlivraison
     *
     * @return \Welinkeo\CatalogueBundle\Entity\Pointlivraison
     */

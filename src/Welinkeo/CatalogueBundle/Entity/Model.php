 ...
 * @ORM\Entity(repositoryClass="Welinkeo\CatalogueBundle\Repository\ModelRepository")
 */
class Model
{
    /**
     ...
     * Add souscategorie
     *
     * @param \Welinkeo\CatalogueBundle\Entity\Souscategorie $souscategorie
     *
     * @return Model
     */
    public function addSouscategorie(\Welinkeo\CatalogueBundle\Entity\Souscategorie $souscategorie)
    {
     ...
     * @param \Welinkeo\CatalogueBundle\Entity\Souscategorie $souscategorie
     */
    public function removeSouscategorie(\Welinkeo\CatalogueBundle\Entity\Souscategorie $souscategorie)
    {
     ...
     * Add depot
     *
     * @param \Welinkeo\CatalogueBundle\Entity\Depot $depot
     *
     * @return Model
     */
    public function addDepot(\Welinkeo\CatalogueBundle\Entity\Depot $depot)
    {
        $this->depot[] = $depot;
     ...
     * @param \Welinkeo\CatalogueBundle\Entity\Depot $depot
     */
    public function removeDepot(\Welinkeo\CatalogueBundle\Entity\Depot $depot)
    {

 ...
 * @ORM\Entity(repositoryClass="Welinkeo\CatalogueBundle\Repository\FactureRepository")
 */
class Facture
{
    /**
     ...
     * @return Facture
     */
    public function setCommandeNumerocommande(\Welinkeo\CatalogueBundle\Entity\Commande $commandeNumerocommande)
    {

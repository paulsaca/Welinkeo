 ...
 * @ORM\Entity(repositoryClass="Welinkeo\CatalogueBundle\Repository\LignecommandeRepository")
 */
class Lignecommande
{
    /**
     ...
     *
     * @param \Welinkeo\CatalogueBundle\Entity\Commande $commandeNumerocommande
     *
     * @return Lignecommande
     */
    public function setCommandeNumerocommande(\Welinkeo\CatalogueBundle\Entity\Commande $commandeNumerocommande = null)
    {
     ...
     *
     * @return \Welinkeo\CatalogueBundle\Entity\Commande
     */

 ...
 * @ORM\Entity(repositoryClass="Welinkeo\CatalogueBundle\Repository\UtilisateurRepository")
 */
class Utilisateur
{
    /**
     ...
     * Set role
     *
     * @param \Welinkeo\CatalogueBundle\Entity\Role $role
     *
     * @return Utilisateur
     */
    public function setRole(\Welinkeo\CatalogueBundle\Entity\Role $role = null)
    {
        $this->role = $role;
     ...
     * Get role
     *
     * @return \Welinkeo\CatalogueBundle\Entity\Role
     */
     ...
     * Set personne
     *
     * @param \Welinkeo\CatalogueBundle\Entity\Personne $personne
     *
     * @return Utilisateur
     */
    public function setPersonne(\Welinkeo\CatalogueBundle\Entity\Personne $personne)
    {
     ...
     * Get personne
     *
     * @return \Welinkeo\CatalogueBundle\Entity\Personne
     */

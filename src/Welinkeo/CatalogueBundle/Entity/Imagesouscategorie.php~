 ...
 * @ORM\Entity(repositoryClass="Welinkeo\CatalogueBundle\Repository\ImagesouscategorieRepository")
 */
class Imagesouscategorie
{
     ...
     * @return Imagesouscategorie
     */
    public function setSouscategorie(\Welinkeo\CatalogueBundle\Entity\Souscategorie $souscategorie = null)
    {
     ...
     * Get souscategorie
     *
     * @return \Welinkeo\CatalogueBundle\Entity\Souscategorie
     */

 ...
 * @ORM\Entity(repositoryClass="Welinkeo\CatalogueBundle\Repository\SouscategorieRepository")
 */
class Souscategorie
{
    /**
     ...
     * Add model
     *
     * @param \Welinkeo\CatalogueBundle\Entity\Model $model
     *
     * @return Souscategorie
     */
    public function addModel(\Welinkeo\CatalogueBundle\Entity\Model $model)
    {
        $this->model[] = $model;
     ...
     * @param \Welinkeo\CatalogueBundle\Entity\Model $model
     */
    public function removeModel(\Welinkeo\CatalogueBundle\Entity\Model $model)
    {

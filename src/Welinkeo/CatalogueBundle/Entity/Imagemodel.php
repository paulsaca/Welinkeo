 ...
 * @ORM\Entity(repositoryClass="Welinkeo\CatalogueBundle\Repository\ImagemodelRepository")
 */
class Imagemodel
{
    /**
     ...
     * @return Imagemodel
     */
    public function setModel(\Welinkeo\CatalogueBundle\Entity\Model $model = null)
    {
        $this->model = $model;
     ...
     * Get model
     *
     * @return \Welinkeo\CatalogueBundle\Entity\Model
     */

 ...
 * @ORM\Entity(repositoryClass="Welinkeo\CommandeBundle\Repository\ModelRepository")
 */
class Model
{
    /**
     ...
     * Add souscategorie
     *
     * @param \Welinkeo\CommandeBundle\Entity\Souscategorie $souscategorie
     *
     * @return Model
     */
    public function addSouscategorie(\Welinkeo\CommandeBundle\Entity\Souscategorie $souscategorie)
    {
     ...
     * @param \Welinkeo\CommandeBundle\Entity\Souscategorie $souscategorie
     */
    public function removeSouscategorie(\Welinkeo\CommandeBundle\Entity\Souscategorie $souscategorie)
    {
     ...
     * Add depot
     *
     * @param \Welinkeo\CommandeBundle\Entity\Depot $depot
     *
     * @return Model
     */
    public function addDepot(\Welinkeo\CommandeBundle\Entity\Depot $depot)
    {
        $this->depot[] = $depot;
     ...
     * @param \Welinkeo\CommandeBundle\Entity\Depot $depot
     */
    public function removeDepot(\Welinkeo\CommandeBundle\Entity\Depot $depot)
    {

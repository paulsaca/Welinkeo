 ...
 * @ORM\Entity(repositoryClass="Welinkeo\CommandeBundle\Repository\FactureRepository")
 */
class Facture
{
    /**
     ...
     * @return Facture
     */
    public function setCommandeNumerocommande(\Welinkeo\CommandeBundle\Entity\Commande $commandeNumerocommande)
    {

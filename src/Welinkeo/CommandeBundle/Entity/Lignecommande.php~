 ...
 * @ORM\Entity(repositoryClass="Welinkeo\CommandeBundle\Repository\LignecommandeRepository")
 */
class Lignecommande
{
    /**
     ...
     *
     * @param \Welinkeo\CommandeBundle\Entity\Commande $commandeNumerocommande
     *
     * @return Lignecommande
     */
    public function setCommandeNumerocommande(\Welinkeo\CommandeBundle\Entity\Commande $commandeNumerocommande = null)
    {
     ...
     *
     * @return \Welinkeo\CommandeBundle\Entity\Commande
     */

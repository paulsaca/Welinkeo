 ...
 * @ORM\Entity(repositoryClass="Welinkeo\CommandeBundle\Repository\UtilisateurRepository")
 */
class Utilisateur
{
    /**
     ...
     * Set role
     *
     * @param \Welinkeo\CommandeBundle\Entity\Role $role
     *
     * @return Utilisateur
     */
    public function setRole(\Welinkeo\CommandeBundle\Entity\Role $role = null)
    {
        $this->role = $role;
     ...
     * Get role
     *
     * @return \Welinkeo\CommandeBundle\Entity\Role
     */
     ...
     * Set personne
     *
     * @param \Welinkeo\CommandeBundle\Entity\Personne $personne
     *
     * @return Utilisateur
     */
    public function setPersonne(\Welinkeo\CommandeBundle\Entity\Personne $personne)
    {
     ...
     * Get personne
     *
     * @return \Welinkeo\CommandeBundle\Entity\Personne
     */

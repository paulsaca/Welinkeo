 ...
 * @ORM\Entity(repositoryClass="Welinkeo\CommandeBundle\Repository\ImagesouscategorieRepository")
 */
class Imagesouscategorie
{
     ...
     * @return Imagesouscategorie
     */
    public function setSouscategorie(\Welinkeo\CommandeBundle\Entity\Souscategorie $souscategorie = null)
    {
     ...
     * Get souscategorie
     *
     * @return \Welinkeo\CommandeBundle\Entity\Souscategorie
     */

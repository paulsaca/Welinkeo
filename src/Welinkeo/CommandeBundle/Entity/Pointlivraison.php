 ...
 * @ORM\Entity(repositoryClass="Welinkeo\CommandeBundle\Repository\PointlivraisonRepository")
 */
class Pointlivraison
{
     ...
     *
     * @param \Welinkeo\CommandeBundle\Entity\Typepointlivraison $typepointlivraison
     *
     * @return Pointlivraison
     */
    public function setTypepointlivraison(\Welinkeo\CommandeBundle\Entity\Typepointlivraison $typepointlivraison = null)
    {
     ...
     *
     * @return \Welinkeo\CommandeBundle\Entity\Typepointlivraison
     */
     ...
     * Set adresse
     *
     * @param \Welinkeo\CommandeBundle\Entity\Adresse $adresse
     *
     * @return Pointlivraison
     */
    public function setAdresse(\Welinkeo\CommandeBundle\Entity\Adresse $adresse = null)
    {
     ...
     * Get adresse
     *
     * @return \Welinkeo\CommandeBundle\Entity\Adresse
     */

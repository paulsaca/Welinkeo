 ...
 * @ORM\Entity(repositoryClass="Welinkeo\CommandeBundle\Repository\ImagemodelRepository")
 */
class Imagemodel
{
    /**
     ...
     * @return Imagemodel
     */
    public function setModel(\Welinkeo\CommandeBundle\Entity\Model $model = null)
    {
        $this->model = $model;
     ...
     * Get model
     *
     * @return \Welinkeo\CommandeBundle\Entity\Model
     */

 ...
 * @ORM\Entity(repositoryClass="Welinkeo\CommandeBundle\Repository\CommandeRepository")
 */
class Commande
{
    /**
     ...
     * Set commandestatut
     *
     * @param \Welinkeo\CommandeBundle\Entity\Commandestatut $commandestatut
     *
     * @return Commande
     */
    public function setCommandestatut(\Welinkeo\CommandeBundle\Entity\Commandestatut $commandestatut = null)
    {
     ...
     * Get commandestatut
     *
     * @return \Welinkeo\CommandeBundle\Entity\Commandestatut
     */
     ...
     * Set modepaiement
     *
     * @param \Welinkeo\CommandeBundle\Entity\Modepaiement $modepaiement
     *
     * @return Commande
     */
    public function setModepaiement(\Welinkeo\CommandeBundle\Entity\Modepaiement $modepaiement = null)
    {
     ...
     * Get modepaiement
     *
     * @return \Welinkeo\CommandeBundle\Entity\Modepaiement
     */
     ...
     * Set modelivraison
     *
     * @param \Welinkeo\CommandeBundle\Entity\Modelivraison $modelivraison
     *
     * @return Commande
     */
    public function setModelivraison(\Welinkeo\CommandeBundle\Entity\Modelivraison $modelivraison = null)
    {
     ...
     * Get modelivraison
     *
     * @return \Welinkeo\CommandeBundle\Entity\Modelivraison
     */
     ...
     * Set ordonnance
     *
     * @param \Welinkeo\CommandeBundle\Entity\Ordonnance $ordonnance
     *
     * @return Commande
     */
    public function setOrdonnance(\Welinkeo\CommandeBundle\Entity\Ordonnance $ordonnance = null)
    {
     ...
     * Get ordonnance
     *
     * @return \Welinkeo\CommandeBundle\Entity\Ordonnance
     */
     ...
     *
     * @param \Welinkeo\CommandeBundle\Entity\Beneficiaire $beneficiairePersonne
     *
     * @return Commande
     */
    public function setBeneficiairePersonne(\Welinkeo\CommandeBundle\Entity\Beneficiaire $beneficiairePersonne = null)
    {
     ...
     *
     * @return \Welinkeo\CommandeBundle\Entity\Beneficiaire
     */
     ...
     *
     * @param \Welinkeo\CommandeBundle\Entity\Utilisateur $utilisateurPersonne
     *
     * @return Commande
     */
    public function setUtilisateurPersonne(\Welinkeo\CommandeBundle\Entity\Utilisateur $utilisateurPersonne = null)
    {
     ...
     *
     * @return \Welinkeo\CommandeBundle\Entity\Utilisateur
     */
     ...
     * Set pointlivraison
     *
     * @param \Welinkeo\CommandeBundle\Entity\Pointlivraison $pointlivraison
     *
     * @return Commande
     */
    public function setPointlivraison(\Welinkeo\CommandeBundle\Entity\Pointlivraison $pointlivraison = null)
    {
     ...
     * Get pointlivraison
     *
     * @return \Welinkeo\CommandeBundle\Entity\Pointlivraison
     */

 ...
 * @ORM\Entity(repositoryClass="Welinkeo\GeneralBundle\Repository\ModelRepository")
 */
class Model
{
    /**
     ...
     * Add souscategorie
     *
     * @param \Welinkeo\GeneralBundle\Entity\Souscategorie $souscategorie
     *
     * @return Model
     */
    public function addSouscategorie(\Welinkeo\GeneralBundle\Entity\Souscategorie $souscategorie)
    {
     ...
     * @param \Welinkeo\GeneralBundle\Entity\Souscategorie $souscategorie
     */
    public function removeSouscategorie(\Welinkeo\GeneralBundle\Entity\Souscategorie $souscategorie)
    {
     ...
     * Add depot
     *
     * @param \Welinkeo\GeneralBundle\Entity\Depot $depot
     *
     * @return Model
     */
    public function addDepot(\Welinkeo\GeneralBundle\Entity\Depot $depot)
    {
        $this->depot[] = $depot;
     ...
     * @param \Welinkeo\GeneralBundle\Entity\Depot $depot
     */
    public function removeDepot(\Welinkeo\GeneralBundle\Entity\Depot $depot)
    {

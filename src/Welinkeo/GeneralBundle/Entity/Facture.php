 ...
 * @ORM\Entity(repositoryClass="Welinkeo\GeneralBundle\Repository\FactureRepository")
 */
class Facture
{
    /**
     ...
     * @return Facture
     */
    public function setCommandeNumerocommande(\Welinkeo\GeneralBundle\Entity\Commande $commandeNumerocommande)
    {

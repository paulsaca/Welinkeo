 ...
 * Lignecommande
 *
 * @ORM\Entity(repositoryClass="Welinkeo\GeneralBundle\Repository\LignecommandeRepository")
 * @ORM\Entity
 */
class Lignecommande
{
     ...
     *
     * @param \Welinkeo\GeneralBundle\Entity\Commande $commandeNumerocommande
     *
     * @return Lignecommande
     */
    public function setCommandeNumerocommande(\Welinkeo\GeneralBundle\Entity\Commande $commandeNumerocommande = null)
    {
     ...
     *
     * @return \Welinkeo\GeneralBundle\Entity\Commande
     */

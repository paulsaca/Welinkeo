 ...
 * @ORM\Entity(repositoryClass="Welinkeo\GeneralBundle\Repository\CommandeRepository")
 */
class Commande
{
    /**
     ...
     * Set commandestatut
     *
     * @param \Welinkeo\GeneralBundle\Entity\Commandestatut $commandestatut
     *
     * @return Commande
     */
    public function setCommandestatut(\Welinkeo\GeneralBundle\Entity\Commandestatut $commandestatut = null)
    {
     ...
     * Get commandestatut
     *
     * @return \Welinkeo\GeneralBundle\Entity\Commandestatut
     */
     ...
     * Set modepaiement
     *
     * @param \Welinkeo\GeneralBundle\Entity\Modepaiement $modepaiement
     *
     * @return Commande
     */
    public function setModepaiement(\Welinkeo\GeneralBundle\Entity\Modepaiement $modepaiement = null)
    {
     ...
     * Get modepaiement
     *
     * @return \Welinkeo\GeneralBundle\Entity\Modepaiement
     */
     ...
     * Set modelivraison
     *
     * @param \Welinkeo\GeneralBundle\Entity\Modelivraison $modelivraison
     *
     * @return Commande
     */
    public function setModelivraison(\Welinkeo\GeneralBundle\Entity\Modelivraison $modelivraison = null)
    {
     ...
     * Get modelivraison
     *
     * @return \Welinkeo\GeneralBundle\Entity\Modelivraison
     */
     ...
     * Set ordonnance
     *
     * @param \Welinkeo\GeneralBundle\Entity\Ordonnance $ordonnance
     *
     * @return Commande
     */
    public function setOrdonnance(\Welinkeo\GeneralBundle\Entity\Ordonnance $ordonnance = null)
    {
     ...
     * Get ordonnance
     *
     * @return \Welinkeo\GeneralBundle\Entity\Ordonnance
     */
     ...
     *
     * @param \Welinkeo\GeneralBundle\Entity\Beneficiaire $beneficiairePersonne
     *
     * @return Commande
     */
    public function setBeneficiairePersonne(\Welinkeo\GeneralBundle\Entity\Beneficiaire $beneficiairePersonne = null)
    {
     ...
     *
     * @return \Welinkeo\GeneralBundle\Entity\Beneficiaire
     */
     ...
     *
     * @param \Welinkeo\GeneralBundle\Entity\Utilisateur $utilisateurPersonne
     *
     * @return Commande
     */
    public function setUtilisateurPersonne(\Welinkeo\GeneralBundle\Entity\Utilisateur $utilisateurPersonne = null)
    {
     ...
     *
     * @return \Welinkeo\GeneralBundle\Entity\Utilisateur
     */
     ...
     * Set pointlivraison
     *
     * @param \Welinkeo\GeneralBundle\Entity\Pointlivraison $pointlivraison
     *
     * @return Commande
     */
    public function setPointlivraison(\Welinkeo\GeneralBundle\Entity\Pointlivraison $pointlivraison = null)
    {
     ...
     * Get pointlivraison
     *
     * @return \Welinkeo\GeneralBundle\Entity\Pointlivraison
     */

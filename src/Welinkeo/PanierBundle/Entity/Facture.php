 ...
 * @ORM\Entity(repositoryClass="Welinkeo\PanierBundle\Repository\FactureRepository")
 */
class Facture
{
    /**
     ...
     * @return Facture
     */
    public function setCommandeNumerocommande(\Welinkeo\PanierBundle\Entity\Commande $commandeNumerocommande)
    {

 ...
 * @ORM\Entity(repositoryClass="Welinkeo\PanierBundle\Repository\LignecommandeRepository")
 */
class Lignecommande
{
    /**
     ...
     *
     * @param \Welinkeo\PanierBundle\Entity\Commande $commandeNumerocommande
     *
     * @return Lignecommande
     */
    public function setCommandeNumerocommande(\Welinkeo\PanierBundle\Entity\Commande $commandeNumerocommande = null)
    {
     ...
     *
     * @return \Welinkeo\PanierBundle\Entity\Commande
     */

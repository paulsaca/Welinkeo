 ...
 * @ORM\Entity(repositoryClass="Welinkeo\PanierBundle\Repository\ImagesouscategorieRepository")
 */
class Imagesouscategorie
{
     ...
     * @return Imagesouscategorie
     */
    public function setSouscategorie(\Welinkeo\PanierBundle\Entity\Souscategorie $souscategorie = null)
    {
     ...
     * Get souscategorie
     *
     * @return \Welinkeo\PanierBundle\Entity\Souscategorie
     */

 ...
 * @ORM\Entity(repositoryClass="Welinkeo\UtilisateurBundle\Repository\ModelRepository")
 */
class Model
{
    /**
     ...
     * Add souscategorie
     *
     * @param \Welinkeo\UtilisateurBundle\Entity\Souscategorie $souscategorie
     *
     * @return Model
     */
    public function addSouscategorie(\Welinkeo\UtilisateurBundle\Entity\Souscategorie $souscategorie)
    {
     ...
     * @param \Welinkeo\UtilisateurBundle\Entity\Souscategorie $souscategorie
     */
    public function removeSouscategorie(\Welinkeo\UtilisateurBundle\Entity\Souscategorie $souscategorie)
    {
     ...
     * Add depot
     *
     * @param \Welinkeo\UtilisateurBundle\Entity\Depot $depot
     *
     * @return Model
     */
    public function addDepot(\Welinkeo\UtilisateurBundle\Entity\Depot $depot)
    {
        $this->depot[] = $depot;
     ...
     * @param \Welinkeo\UtilisateurBundle\Entity\Depot $depot
     */
    public function removeDepot(\Welinkeo\UtilisateurBundle\Entity\Depot $depot)
    {

...
class Commande
{
     ...
     * Set commandestatut
     *
     * @param \Welinkeo\UtilisateurBundle\Entity\Commandestatut $commandestatut
     *
     * @return Commande
     */
    public function setCommandestatut(\Welinkeo\UtilisateurBundle\Entity\Commandestatut $commandestatut = null)
    {
     ...
     * Get commandestatut
     *
     * @return \Welinkeo\UtilisateurBundle\Entity\Commandestatut
     */
     ...
     * Set modepaiement
     *
     * @param \Welinkeo\UtilisateurBundle\Entity\Modepaiement $modepaiement
     *
     * @return Commande
     */
    public function setModepaiement(\Welinkeo\UtilisateurBundle\Entity\Modepaiement $modepaiement = null)
    {
     ...
     * Get modepaiement
     *
     * @return \Welinkeo\UtilisateurBundle\Entity\Modepaiement
     */
     ...
     * Set modelivraison
     *
     * @param \Welinkeo\UtilisateurBundle\Entity\Modelivraison $modelivraison
     *
     * @return Commande
     */
    public function setModelivraison(\Welinkeo\UtilisateurBundle\Entity\Modelivraison $modelivraison = null)
    {
     ...
     * Get modelivraison
     *
     * @return \Welinkeo\UtilisateurBundle\Entity\Modelivraison
     */
     ...
     * Set ordonnance
     *
     * @param \Welinkeo\UtilisateurBundle\Entity\Ordonnance $ordonnance
     *
     * @return Commande
     */
    public function setOrdonnance(\Welinkeo\UtilisateurBundle\Entity\Ordonnance $ordonnance = null)
    {
     ...
     * Get ordonnance
     *
     * @return \Welinkeo\UtilisateurBundle\Entity\Ordonnance
     */
     ...
     *
     * @param \Welinkeo\UtilisateurBundle\Entity\Beneficiaire $beneficiairePersonne
     *
     * @return Commande
     */
    public function setBeneficiairePersonne(\Welinkeo\UtilisateurBundle\Entity\Beneficiaire $beneficiairePersonne = null)
    {
     ...
     *
     * @return \Welinkeo\UtilisateurBundle\Entity\Beneficiaire
     */
     ...
     * @return Commande
     */
    public function setUtilisateurPersonne(\Welinkeo\UtilisateurBundle\Entity\Utilisateur $utilisateurPersonne = null)
    {

 ...
 * @ORM\Entity(repositoryClass="Welinkeo\BackOfficeBundle\Repository\CommandeRepository")
 */
class Commande
{
    /**
     ...
     * Set commandestatut
     *
     * @param \Welinkeo\BackOfficeBundle\Entity\Commandestatut $commandestatut
     *
     * @return Commande
     */
    public function setCommandestatut(\Welinkeo\BackOfficeBundle\Entity\Commandestatut $commandestatut = null)
    {
     ...
     * Get commandestatut
     *
     * @return \Welinkeo\BackOfficeBundle\Entity\Commandestatut
     */
     ...
     * Set modepaiement
     *
     * @param \Welinkeo\BackOfficeBundle\Entity\Modepaiement $modepaiement
     *
     * @return Commande
     */
    public function setModepaiement(\Welinkeo\BackOfficeBundle\Entity\Modepaiement $modepaiement = null)
    {
     ...
     * Get modepaiement
     *
     * @return \Welinkeo\BackOfficeBundle\Entity\Modepaiement
     */
     ...
     * Set modelivraison
     *
     * @param \Welinkeo\BackOfficeBundle\Entity\Modelivraison $modelivraison
     *
     * @return Commande
     */
    public function setModelivraison(\Welinkeo\BackOfficeBundle\Entity\Modelivraison $modelivraison = null)
    {
     ...
     * Get modelivraison
     *
     * @return \Welinkeo\BackOfficeBundle\Entity\Modelivraison
     */
     ...
     * Set ordonnance
     *
     * @param \Welinkeo\BackOfficeBundle\Entity\Ordonnance $ordonnance
     *
     * @return Commande
     */
    public function setOrdonnance(\Welinkeo\BackOfficeBundle\Entity\Ordonnance $ordonnance = null)
    {
     ...
     * Get ordonnance
     *
     * @return \Welinkeo\BackOfficeBundle\Entity\Ordonnance
     */
     ...
     *
     * @param \Welinkeo\BackOfficeBundle\Entity\Beneficiaire $beneficiairePersonne
     *
     * @return Commande
     */
    public function setBeneficiairePersonne(\Welinkeo\BackOfficeBundle\Entity\Beneficiaire $beneficiairePersonne = null)
    {
     ...
     *
     * @return \Welinkeo\BackOfficeBundle\Entity\Beneficiaire
     */
     ...
     *
     * @param \Welinkeo\BackOfficeBundle\Entity\Utilisateur $utilisateurPersonne
     *
     * @return Commande
     */
    public function setUtilisateurPersonne(\Welinkeo\BackOfficeBundle\Entity\Utilisateur $utilisateurPersonne = null)
    {
     ...
     *
     * @return \Welinkeo\BackOfficeBundle\Entity\Utilisateur
     */
     ...
     * Set pointlivraison
     *
     * @param \Welinkeo\BackOfficeBundle\Entity\Pointlivraison $pointlivraison
     *
     * @return Commande
     */
    public function setPointlivraison(\Welinkeo\BackOfficeBundle\Entity\Pointlivraison $pointlivraison = null)
    {
     ...
     * Get pointlivraison
     *
     * @return \Welinkeo\BackOfficeBundle\Entity\Pointlivraison
     */

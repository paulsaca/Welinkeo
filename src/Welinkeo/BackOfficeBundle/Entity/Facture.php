 ...
 * @ORM\Entity(repositoryClass="Welinkeo\BackOfficeBundle\Repository\FactureRepository")
 */
class Facture
{
    /**
     ...
     * @return Facture
     */
    public function setCommandeNumerocommande(\Welinkeo\BackOfficeBundle\Entity\Commande $commandeNumerocommande)
    {

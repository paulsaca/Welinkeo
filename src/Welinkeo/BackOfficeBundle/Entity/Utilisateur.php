 ...
 * @ORM\Entity(repositoryClass="Welinkeo\BackOfficeBundle\Repository\UtilisateurRepository")
 */
class Utilisateur
{
    /**
     ...
     * Set role
     *
     * @param \Welinkeo\BackOfficeBundle\Entity\Role $role
     *
     * @return Utilisateur
     */
    public function setRole(\Welinkeo\BackOfficeBundle\Entity\Role $role = null)
    {
        $this->role = $role;
     ...
     * Get role
     *
     * @return \Welinkeo\BackOfficeBundle\Entity\Role
     */
     ...
     * Set personne
     *
     * @param \Welinkeo\BackOfficeBundle\Entity\Personne $personne
     *
     * @return Utilisateur
     */
    public function setPersonne(\Welinkeo\BackOfficeBundle\Entity\Personne $personne)
    {
     ...
     * Get personne
     *
     * @return \Welinkeo\BackOfficeBundle\Entity\Personne
     */

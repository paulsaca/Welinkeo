 ...
 * @ORM\Entity(repositoryClass="Welinkeo\BackOfficeBundle\Repository\ImagemodelRepository")
 */
class Imagemodel
{
    /**
     ...
     * @return Imagemodel
     */
    public function setModel(\Welinkeo\BackOfficeBundle\Entity\Model $model = null)
    {
        $this->model = $model;
     ...
     * Get model
     *
     * @return \Welinkeo\BackOfficeBundle\Entity\Model
     */

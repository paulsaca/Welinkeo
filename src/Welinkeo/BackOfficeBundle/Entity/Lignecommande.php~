 ...
 * @ORM\Entity(repositoryClass="Welinkeo\BackOfficeBundle\Repository\LignecommandeRepository")
 */
class Lignecommande
{
    /**
     ...
     *
     * @param \Welinkeo\BackOfficeBundle\Entity\Commande $commandeNumerocommande
     *
     * @return Lignecommande
     */
    public function setCommandeNumerocommande(\Welinkeo\BackOfficeBundle\Entity\Commande $commandeNumerocommande = null)
    {
     ...
     *
     * @return \Welinkeo\BackOfficeBundle\Entity\Commande
     */
